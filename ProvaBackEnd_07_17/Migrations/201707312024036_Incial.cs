namespace ProvaBackEnd_07_17.Migrations
{
    ...
    public partial class Incial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.NoticiaItems", "TipoId", "dbo.Tipoes");
            DropForeignKey("dbo.NoticiaItems", "NoticiaId", "dbo.Noticias");
            ...
            DropIndex("dbo.NoticiaItems", new[] { "NoticiaId" });
            DropIndex("dbo.NoticiaItems", new[] { "TipoId" });
